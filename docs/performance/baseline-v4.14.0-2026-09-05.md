...
| Version | v4.14.0 |
| Pages on disk | 18147 |
| Resident memory (idle) | 3642.8 MB |
| Memory source | telemetry |
| Heap used | 945.6 MB |
| Heap total | 1414.5 MB |
| Engine init duration (mean from telemetry) | 4777 ms |
...
## Drift vs baseline-v4.13.0-2026-09-03.md

⚠️  __Regression candidate(s):__ memory (+99.5%)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1825.9 MB | 3642.8 MB | +1816.9 MB (+99.5%) |
| `/` | 32 ms | 41 ms | +9 ms (+28.1%) |
| `/view/Welcome` | 30 ms | 40 ms | +10 ms (+33.3%) |
| `/search?q=test` | 58 ms | 66 ms | +8 ms (+13.8%) |
| `/login` | 30 ms | 37 ms | +7 ms (+23.3%) |
