...
| Version | v3.44.5 |
| Pages on disk | 17539 |
| Resident memory (idle) | 3286.9 MB |
| Memory source | telemetry |
| Heap used | 758.6 MB |
| Heap total | 1105.3 MB |
| Engine init duration (mean from telemetry) | 4504 ms |
...
## Drift vs baseline-v3.44.4-2026-05-28.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3101.1 MB | 3286.9 MB | +185.8 MB (+6.0%) |
| `/` | 30 ms | 27 ms | -3 ms (-10.0%) |
| `/view/Welcome` | 21 ms | 21 ms | +0 ms (+0.0%) |
| `/search?q=test` | 147 ms | 156 ms | +9 ms (+6.1%) |
