...
| Version | v3.43.8 |
| Pages on disk | 17537 |
| Resident memory (idle) | 1399.7 MB |
| Memory source | telemetry |
| Heap used | 798.7 MB |
| Heap total | 879.7 MB |
| Engine init duration (mean from telemetry) | 4352 ms |
...
## Drift vs baseline-v3.43.7-2026-05-26.md

⚠️  __Regression candidate(s):__ / (+354.8%, +110ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3162.0 MB | 1399.7 MB | -1762.3 MB (-55.7%) |
| `/` | 31 ms | 141 ms | +110 ms (+354.8%) |
| `/view/Welcome` | 21 ms | 20 ms | -1 ms (-4.8%) |
| `/search?q=test` | 157 ms | 156 ms | -1 ms (-0.6%) |
