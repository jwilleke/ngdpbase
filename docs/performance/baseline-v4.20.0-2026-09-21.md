# Performance baseline — v4.20.0

Captured 2026-09-21 on instance `jimstest` (port 3000).
...
| Version | v4.20.0 |
| Pages on disk | 18267 |
| Resident memory (idle) | 2699.7 MB |
| Memory source | telemetry |
| Heap used | 1008.1 MB |
| Heap total | 1246.5 MB |
| Engine init duration (mean from telemetry) | 5022 ms |
| Link-graph entries | 37691 |
...
## Drift vs baseline-v4.19.0-2026-09-20.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3248.0 MB | 2699.7 MB | -548.3 MB (-16.9%) |
| `/` | 25 ms | 27 ms | +2 ms (+8.0%) |
| `/view/Welcome` | 22 ms | 23 ms | +1 ms (+4.5%) |
| `/search?q=test` | 48 ms | 49 ms | +1 ms (+2.1%) |
