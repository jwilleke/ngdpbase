...
| Version | v4.10.0 |
| Pages on disk | 17951 |
| Resident memory (idle) | 1935.4 MB |
| Memory source | telemetry |
| Heap used | 906.6 MB |
| Heap total | 1088.1 MB |
| Engine init duration (mean from telemetry) | 4769 ms |
...
| --- | --- | --- | --- |
| Memory (idle) | 3358.8 MB | 1935.4 MB | -1423.4 MB (-42.4%) |
