...
| Version | v3.11.3 |
| Pages on disk | 17497 |
| Resident memory (idle) | 3467.2 MB |
| Memory source | telemetry |
| Heap used | 957.3 MB |
| Heap total | 1801.3 MB |
...
## Drift vs baseline-v3.10.2-2026-05-07.md

⚠️  __Regression candidate(s):__ / (+552.4%, +116ms); /search?q=test (+89.9%, +116ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3495.9 MB | 3467.2 MB | -28.7 MB (-0.8%) |
| `/` | 21 ms | 137 ms | +116 ms (+552.4%) |
| `/view/Welcome` | 17 ms | 15 ms | -2 ms (-11.8%) |
| `/search?q=test` | 129 ms | 245 ms | +116 ms (+89.9%) |
| `/login` | 17 ms | 15 ms | -2 ms (-11.8%) |
