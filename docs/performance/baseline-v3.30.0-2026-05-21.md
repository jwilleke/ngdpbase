...
| Version | v3.30.0 |
| Pages on disk | 17532 |
| Resident memory (idle) | 3286.2 MB |
| Memory source | telemetry |
| Heap used | 754.4 MB |
| Heap total | 1135.9 MB |
| Engine init duration (mean from telemetry) | 4431 ms |
...
## Drift vs baseline-v3.29.1-2026-05-21.md

⚠️  __Regression candidate(s):__ memory (+136.1%)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1391.6 MB | 3286.2 MB | +1894.6 MB (+136.1%) |
| `/` | 26 ms | 26 ms | +0 ms (+0.0%) |
| `/view/Welcome` | 21 ms | 22 ms | +1 ms (+4.8%) |
| `/search?q=test` | 153 ms | 161 ms | +8 ms (+5.2%) |
