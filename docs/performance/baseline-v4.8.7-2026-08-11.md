# Performance baseline — v4.8.7

Captured 2026-08-11 on instance `pm2-logrotate` (port 3000).
...
| Version | v4.8.7 |
| Pages on disk | 17914 |
| Resident memory (idle) | 3532.2 MB |
| Memory source | telemetry |
| Heap used | 922.2 MB |
| Heap total | 1554.5 MB |
| Engine init duration (mean from telemetry) | 5366 ms |
| Link-graph entries | 37121 |
...
## Drift vs baseline-v4.8.6-2026-08-10.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3570.2 MB | 3532.2 MB | -38.0 MB (-1.1%) |
| `/` | 25 ms | 22 ms | -3 ms (-12.0%) |
| `/view/Welcome` | 21 ms | 20 ms | -1 ms (-4.8%) |
| `/search?q=test` | 45 ms | 43 ms | -2 ms (-4.4%) |
