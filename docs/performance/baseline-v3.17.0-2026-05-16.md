...
| Version | v3.17.0 |
| Pages on disk | 17523 |
| Resident memory (idle) | 3586.9 MB |
| Memory source | telemetry |
| Heap used | 1766.8 MB |
| Heap total | 2389.0 MB |
| Engine init duration (mean from telemetry) | 5620 ms |
...
## Drift vs baseline-v3.16.1-2026-05-16.md

⚠️  __Regression candidate(s):__ /search?q=test (+531.8%, +117ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3603.4 MB | 3586.9 MB | -16.5 MB (-0.5%) |
| `/` | 28 ms | 31 ms | +3 ms (+10.7%) |
| `/view/Welcome` | 22 ms | 22 ms | +0 ms (+0.0%) |
| `/search?q=test` | 22 ms | 139 ms | +117 ms (+531.8%) |
