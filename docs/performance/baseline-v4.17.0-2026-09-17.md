...
| Version | v4.17.0 |
| Pages on disk | 18235 |
| Resident memory (idle) | 3609.0 MB |
| Memory source | telemetry |
| Heap used | 879.7 MB |
| Heap total | 1326.3 MB |
| Engine init duration (mean from telemetry) | 5026 ms |
...
## Drift vs baseline-v4.16.6-2026-09-16.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3405.3 MB | 3609.0 MB | +203.7 MB (+6.0%) |
| `/` | 26 ms | 28 ms | +2 ms (+7.7%) |
| `/view/Welcome` | 23 ms | 23 ms | +0 ms (+0.0%) |
| `/search?q=test` | 47 ms | 48 ms | +1 ms (+2.1%) |
