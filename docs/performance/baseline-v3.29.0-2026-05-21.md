...
| Version | v3.29.0 |
| Pages on disk | 17532 |
| Resident memory (idle) | 3222.9 MB |
| Memory source | telemetry |
| Heap used | 879.2 MB |
| Heap total | 1310.0 MB |
| Engine init duration (mean from telemetry) | 4026 ms |
...
## Drift vs baseline-v3.28.0-2026-05-21.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3230.2 MB | 3222.9 MB | -7.3 MB (-0.2%) |
| `/` | 24 ms | 25 ms | +1 ms (+4.2%) |
| `/view/Welcome` | 19 ms | 21 ms | +2 ms (+10.5%) |
| `/search?q=test` | 37 ms | 40 ms | +3 ms (+8.1%) |
