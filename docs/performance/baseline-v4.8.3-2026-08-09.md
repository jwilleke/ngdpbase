# Performance baseline — v4.8.3

Captured 2026-08-09 on instance `pm2-logrotate` (port 3000).
...
| Version | v4.8.3 |
| Pages on disk | 17913 |
| Resident memory (idle) | 3596.8 MB |
| Memory source | telemetry |
| Heap used | 980.0 MB |
| Heap total | 1452.5 MB |
| Engine init duration (mean from telemetry) | 5460 ms |
| Link-graph entries | 37117 |
...
## Drift vs baseline-v4.8.2-2026-08-09.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3585.7 MB | 3596.8 MB | +11.1 MB (+0.3%) |
| `/` | 26 ms | 25 ms | -1 ms (-3.8%) |
| `/view/Welcome` | 22 ms | 21 ms | -1 ms (-4.5%) |
| `/search?q=test` | 45 ms | 46 ms | +1 ms (+2.2%) |
| `/login` | 23 ms | 20 ms | -3 ms (-13.0%) |
