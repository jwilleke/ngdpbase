# Performance baseline — v4.5.2

Captured 2026-08-07 on instance `pm2-logrotate` (port 3000).
...
| Version | v4.5.2 |
| Pages on disk | 17898 |
| Resident memory (idle) | 3615.0 MB |
| Memory source | telemetry |
| Heap used | 1160.1 MB |
| Heap total | 2123.3 MB |
| Engine init duration (mean from telemetry) | 5418 ms |
...
## Drift vs baseline-v4.5.1-2026-08-06.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3645.0 MB | 3615.0 MB | -30.0 MB (-0.8%) |
| `/` | 26 ms | 25 ms | -1 ms (-3.8%) |
| `/view/Welcome` | 22 ms | 21 ms | -1 ms (-4.5%) |
| `/search?q=test` | 43 ms | 44 ms | +1 ms (+2.3%) |
