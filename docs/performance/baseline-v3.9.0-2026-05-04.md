...
| Version | v3.9.0 |
| Pages on disk | 17479 |
| Resident memory (idle) | 2098.8 MB |
| Memory source | telemetry |
| Heap used | 952.3 MB |
| Heap total | 1333.6 MB |
| Engine init duration (mean from telemetry) | 5213 ms |
| Link-graph entries | 36260 |
...
## Drift vs baseline-v3.8.0-2026-05-03.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3665.7 MB | 2098.8 MB | -1566.9 MB (-42.7%) |
| `/` | 20 ms | 26 ms | +6 ms (+30.0%) |
| `/view/Welcome` | 16 ms | 18 ms | +2 ms (+12.5%) |
| `/search?q=test` | 127 ms | 129 ms | +2 ms (+1.6%) |
| `/login` | 16 ms | 17 ms | +1 ms (+6.2%) |
