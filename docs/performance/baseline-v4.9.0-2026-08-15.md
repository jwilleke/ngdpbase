...
| Version | v4.9.0 |
| Pages on disk | 17949 |
| Resident memory (idle) | 1770.7 MB |
| Memory source | telemetry |
| Heap used | 906.2 MB |
| Heap total | 1048.7 MB |
| Engine init duration (mean from telemetry) | 5106 ms |
...
## Drift vs baseline-v4.8.9-2026-08-14.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1919.7 MB | 1770.7 MB | -149.0 MB (-7.8%) |
| `/` | 25 ms | 25 ms | +0 ms (+0.0%) |
| `/view/Welcome` | 21 ms | 21 ms | +0 ms (+0.0%) |
| `/search?q=test` | 43 ms | 43 ms | +0 ms (+0.0%) |
