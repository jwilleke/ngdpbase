...
| Version | v3.29.1 |
| Pages on disk | 17532 |
| Resident memory (idle) | 1391.6 MB |
| Memory source | telemetry |
| Heap used | 791.8 MB |
| Heap total | 893.6 MB |
| Engine init duration (mean from telemetry) | 4407 ms |
...
## Drift vs baseline-v3.29.0-2026-05-21.md

⚠️  __Regression candidate(s):__ /search?q=test (+282.5%, +113ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3222.9 MB | 1391.6 MB | -1831.3 MB (-56.8%) |
| `/` | 25 ms | 26 ms | +1 ms (+4.0%) |
| `/view/Welcome` | 21 ms | 21 ms | +0 ms (+0.0%) |
| `/search?q=test` | 40 ms | 153 ms | +113 ms (+282.5%) |
