...
| Version | v4.6.2 |
| Pages on disk | 17912 |
| Resident memory (idle) | 3551.8 MB |
| Memory source | telemetry |
| Heap used | 1000.5 MB |
| Heap total | 1850.7 MB |
| Engine init duration (mean from telemetry) | 5704 ms |
...
## Drift vs baseline-v4.6.1-2026-08-08.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3760.7 MB | 3551.8 MB | -208.9 MB (-5.6%) |
| `/` | 25 ms | 28 ms | +3 ms (+12.0%) |
| `/view/Welcome` | 21 ms | 23 ms | +2 ms (+9.5%) |
| `/search?q=test` | 42 ms | 46 ms | +4 ms (+9.5%) |
