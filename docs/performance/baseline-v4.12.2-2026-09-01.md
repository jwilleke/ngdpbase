# Performance baseline — v4.12.2

Captured 2026-09-01 on instance `pm2-logrotate` (port 3000).
...
| Version | v4.12.2 |
| Pages on disk | 18130 |
| Resident memory (idle) | 3419.5 MB |
| Memory source | telemetry |
| Heap used | 1022.9 MB |
| Heap total | 1410.0 MB |
| Engine init duration (mean from telemetry) | 6189 ms |
| Link-graph entries | 37466 |
...
## Drift vs baseline-v4.12.1-2026-08-31.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3600.5 MB | 3419.5 MB | -181.0 MB (-5.0%) |
| `/` | 26 ms | 26 ms | +0 ms (+0.0%) |
| `/view/Welcome` | 21 ms | 21 ms | +0 ms (+0.0%) |
| `/search?q=test` | 46 ms | 47 ms | +1 ms (+2.2%) |
