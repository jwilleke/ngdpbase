# Performance baseline — v3.49.0

Captured 2026-06-08 on instance `jimstest` (port 3000).
...
| Version | v3.49.0 |
| Pages on disk | 17565 |
| Resident memory (idle) | 3399.8 MB |
| Memory source | telemetry |
| Heap used | 835.9 MB |
| Heap total | 1231.4 MB |
| Engine init duration (mean from telemetry) | 4171 ms |
| Link-graph entries | 36441 |
...
## Drift vs baseline-v3.48.1-2026-06-03.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3342.6 MB | 3399.8 MB | +57.2 MB (+1.7%) |
| `/` | 27 ms | 28 ms | +1 ms (+3.7%) |
| `/view/Welcome` | 22 ms | 21 ms | -1 ms (-4.5%) |
| `/search?q=test` | 40 ms | 41 ms | +1 ms (+2.5%) |
