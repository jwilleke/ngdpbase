...
| Version | v4.5.0 |
| Pages on disk | 17898 |
| Resident memory (idle) | 3509.5 MB |
| Memory source | telemetry |
| Heap used | 921.6 MB |
| Heap total | 1656.9 MB |
| Engine init duration (mean from telemetry) | 5613 ms |
...
## Drift vs baseline-v4.4.0-2026-08-05.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3655.8 MB | 3509.5 MB | -146.3 MB (-4.0%) |
