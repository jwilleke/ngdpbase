...
| Version | v3.34.0 |
| Pages on disk | 17534 |
| Resident memory (idle) | 3000.9 MB |
| Memory source | telemetry |
| Heap used | 746.5 MB |
| Heap total | 1256.3 MB |
| Engine init duration (mean from telemetry) | 4380 ms |
...
## Drift vs baseline-v3.33.0-2026-05-22.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3035.8 MB | 3000.9 MB | -34.9 MB (-1.1%) |
| `/` | 135 ms | 26 ms | -109 ms (-80.7%) |
| `/view/Welcome` | 20 ms | 19 ms | -1 ms (-5.0%) |
| `/search?q=test` | 148 ms | 153 ms | +5 ms (+3.4%) |
