...
| Version | v3.32.0 |
| Pages on disk | 17534 |
| Resident memory (idle) | 3134.9 MB |
| Memory source | telemetry |
| Heap used | 799.0 MB |
| Heap total | 1483.5 MB |
| Engine init duration (mean from telemetry) | 4084 ms |
...
## Drift vs baseline-v3.31.0-2026-05-21.md

⚠️  __Regression candidate(s):__ /search?q=test (+270.7%, +111ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3222.4 MB | 3134.9 MB | -87.5 MB (-2.7%) |
| `/` | 25 ms | 25 ms | +0 ms (+0.0%) |
| `/view/Welcome` | 21 ms | 20 ms | -1 ms (-4.8%) |
| `/search?q=test` | 41 ms | 152 ms | +111 ms (+270.7%) |
