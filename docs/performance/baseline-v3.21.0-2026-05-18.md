...
| Version | v3.21.0 |
| Pages on disk | 17534 |
| Resident memory (idle) | 1688.0 MB |
| Memory source | telemetry |
| Heap used | 880.4 MB |
| Heap total | 1108.7 MB |
| Engine init duration (mean from telemetry) | 5557 ms |
| Link-graph entries | 36352 |
...
## Drift vs baseline-v3.20.1-2026-05-18.md

⚠️  __Regression candidate(s):__ / (+336.4%, +111ms); /search?q=test (+496.2%, +129ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3657.7 MB | 1688.0 MB | -1969.7 MB (-53.9%) |
| `/` | 33 ms | 144 ms | +111 ms (+336.4%) |
| `/view/Welcome` | 21 ms | 21 ms | +0 ms (+0.0%) |
| `/search?q=test` | 26 ms | 155 ms | +129 ms (+496.2%) |
