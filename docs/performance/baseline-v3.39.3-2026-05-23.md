...
| Version | v3.39.3 |
| Pages on disk | 17534 |
| Resident memory (idle) | 3314.7 MB |
| Memory source | telemetry |
| Heap used | 1508.8 MB |
| Heap total | 1620.3 MB |
| Engine init duration (mean from telemetry) | 4727 ms |
...
## Drift vs baseline-v3.39.2-2026-05-23.md

⚠️  __Regression candidate(s):__ memory (+148.3%)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1334.7 MB | 3314.7 MB | +1980.0 MB (+148.3%) |
| `/` | 149 ms | 143 ms | -6 ms (-4.0%) |
| `/view/Welcome` | 19 ms | 19 ms | +0 ms (+0.0%) |
| `/search?q=test` | 153 ms | 144 ms | -9 ms (-5.9%) |
