...
| Version | v3.44.4 |
| Pages on disk | 17539 |
| Resident memory (idle) | 3101.1 MB |
| Memory source | telemetry |
| Heap used | 765.8 MB |
| Heap total | 1251.7 MB |
| Engine init duration (mean from telemetry) | 4060 ms |
...
## Drift vs baseline-v3.44.3-2026-05-28.md

⚠️  __Regression candidate(s):__ memory (+116.2%)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1434.1 MB | 3101.1 MB | +1667.0 MB (+116.2%) |
| `/` | 141 ms | 30 ms | -111 ms (-78.7%) |
| `/view/Welcome` | 21 ms | 21 ms | +0 ms (+0.0%) |
| `/search?q=test` | 157 ms | 147 ms | -10 ms (-6.4%) |
