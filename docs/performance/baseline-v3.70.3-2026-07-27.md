...
| Version | v3.70.3 |
| Pages on disk | 17822 |
| Resident memory (idle) | 3575.1 MB |
| Memory source | telemetry |
| Heap used | 1729.7 MB |
| Heap total | 2382.9 MB |
| Engine init duration (mean from telemetry) | 4984 ms |
...
## Drift vs baseline-v3.70.2-2026-07-27.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3558.3 MB | 3575.1 MB | +16.8 MB (+0.5%) |
