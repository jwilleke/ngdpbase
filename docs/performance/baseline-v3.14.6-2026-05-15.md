# Performance baseline — v3.14.6

Captured 2026-05-15 on instance `jimstest` (port 3000).
...
| Version | v3.14.6 |
| Pages on disk | 17557 |
| Resident memory (idle) | 3731.2 MB |
| Memory source | telemetry |
| Heap used | 1755.0 MB |
| Heap total | 2140.1 MB |
| Engine init duration (mean from telemetry) | 5001 ms |
| Link-graph entries | 36359 |
...
## Drift vs baseline-v3.14.5-2026-05-14.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3803.1 MB | 3731.2 MB | -71.9 MB (-1.9%) |
| `/` | 33 ms | 30 ms | -3 ms (-9.1%) |
| `/view/Welcome` | 23 ms | 21 ms | -2 ms (-8.7%) |
| `/search?q=test` | 23 ms | 21 ms | -2 ms (-8.7%) |
