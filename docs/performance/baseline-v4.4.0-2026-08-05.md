# Performance baseline — v4.4.0

Captured 2026-08-05 on instance `pm2-logrotate` (port 3000).
...
| Version | v4.4.0 |
| Pages on disk | 17876 |
| Resident memory (idle) | 3655.8 MB |
| Memory source | telemetry |
| Heap used | 996.7 MB |
| Heap total | 2113.9 MB |
| Engine init duration (mean from telemetry) | 5311 ms |
| Link-graph entries | 37033 |
...
## Drift vs baseline-v4.3.0-2026-08-04.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3615.7 MB | 3655.8 MB | +40.1 MB (+1.1%) |
| `/` | 25 ms | 25 ms | +0 ms (+0.0%) |
| `/view/Welcome` | 21 ms | 22 ms | +1 ms (+4.8%) |
| `/search?q=test` | 44 ms | 45 ms | +1 ms (+2.3%) |
