# Performance baseline — v3.48.1

Captured 2026-06-03 on instance `jimstest` (port 3000).
...
| Version | v3.48.1 |
| Pages on disk | 17549 |
| Resident memory (idle) | 3342.6 MB |
| Memory source | telemetry |
| Heap used | 779.4 MB |
| Heap total | 1401.4 MB |
| Engine init duration (mean from telemetry) | 4719 ms |
| Link-graph entries | 36382 |
...
## Drift vs baseline-v3.48.0-2026-06-02.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3410.4 MB | 3342.6 MB | -67.8 MB (-2.0%) |
| `/` | 151 ms | 27 ms | -124 ms (-82.1%) |
| `/view/Welcome` | 21 ms | 22 ms | +1 ms (+4.8%) |
| `/search?q=test` | 159 ms | 40 ms | -119 ms (-74.8%) |
