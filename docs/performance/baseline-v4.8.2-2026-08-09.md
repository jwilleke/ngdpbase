...
| Version | v4.8.2 |
| Pages on disk | 17912 |
| Resident memory (idle) | 3585.7 MB |
| Memory source | telemetry |
| Heap used | 1093.7 MB |
| Heap total | 2038.8 MB |
| Engine init duration (mean from telemetry) | 5233 ms |
...
## Drift vs baseline-v4.8.1-2026-08-09.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3582.1 MB | 3585.7 MB | +3.6 MB (+0.1%) |
