...
| Version | v3.38.0 |
| Pages on disk | 17534 |
| Resident memory (idle) | 1825.8 MB |
| Memory source | telemetry |
| Heap used | 705.1 MB |
| Heap total | 1248.5 MB |
| Engine init duration (mean from telemetry) | 4451 ms |
...
## Drift vs baseline-v3.37.0-2026-05-22.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3278.8 MB | 1825.8 MB | -1453.0 MB (-44.3%) |
| `/` | 144 ms | 147 ms | +3 ms (+2.1%) |
| `/view/Welcome` | 20 ms | 20 ms | +0 ms (+0.0%) |
| `/search?q=test` | 145 ms | 144 ms | -1 ms (-0.7%) |
