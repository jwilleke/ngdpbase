...
| Version | v4.0.0 |
| Pages on disk | 17822 |
| Resident memory (idle) | 3752.4 MB |
| Memory source | telemetry |
| Heap used | 1082.4 MB |
| Heap total | 1804.2 MB |
...
## Drift vs baseline-v3.71.0-2026-07-27.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3558.0 MB | 3752.4 MB | +194.4 MB (+5.5%) |
| `/` | 26 ms | 24 ms | -2 ms (-7.7%) |
| `/view/Welcome` | 23 ms | 21 ms | -2 ms (-8.7%) |
| `/search?q=test` | 47 ms | 44 ms | -3 ms (-6.4%) |
