...
| Version | v3.43.10 |
| Pages on disk | 17538 |
| Resident memory (idle) | 3150.5 MB |
| Memory source | telemetry |
| Heap used | 760.7 MB |
| Heap total | 1163.9 MB |
...
## Drift vs baseline-v3.43.9-2026-05-26.md

⚠️  __Regression candidate(s):__ memory (+119.7%); / (+421.4%, +118ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1434.3 MB | 3150.5 MB | +1716.2 MB (+119.7%) |
| `/` | 28 ms | 146 ms | +118 ms (+421.4%) |
| `/view/Welcome` | 21 ms | 20 ms | -1 ms (-4.8%) |
| `/search?q=test` | 145 ms | 151 ms | +6 ms (+4.1%) |
