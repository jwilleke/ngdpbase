...
| Version | v3.56.0 |
| Pages on disk | 17802 |
| Resident memory (idle) | 3175.6 MB |
| Memory source | telemetry |
| Heap used | 944.6 MB |
| Heap total | 1419.9 MB |
| Engine init duration (mean from telemetry) | 4660 ms |
...
## Drift vs baseline-v3.55.0-2026-07-21.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3415.4 MB | 3175.6 MB | -239.8 MB (-7.0%) |
| `/` | 25 ms | 26 ms | +1 ms (+4.0%) |
| `/view/Welcome` | 21 ms | 21 ms | +0 ms (+0.0%) |
| `/search?q=test` | 43 ms | 45 ms | +2 ms (+4.7%) |
| `/login` | 21 ms | 23 ms | +2 ms (+9.5%) |
