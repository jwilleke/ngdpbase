...
| Version | v3.64.0 |
| Pages on disk | 17822 |
| Resident memory (idle) | 3428.2 MB |
| Memory source | telemetry |
| Heap used | 901.3 MB |
| Heap total | 1632.4 MB |
| Engine init duration (mean from telemetry) | 5183 ms |
...
## Drift vs baseline-v3.63.0-2026-07-23.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3449.5 MB | 3428.2 MB | -21.3 MB (-0.6%) |
| `/` | 24 ms | 28 ms | +4 ms (+16.7%) |
