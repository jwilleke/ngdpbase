...
| Version | v3.63.0 |
| Pages on disk | 17821 |
| Resident memory (idle) | 3449.5 MB |
| Memory source | telemetry |
| Heap used | 901.1 MB |
| Heap total | 1558.2 MB |
| Engine init duration (mean from telemetry) | 5260 ms |
...
## Drift vs baseline-v3.62.1-2026-07-23.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3457.0 MB | 3449.5 MB | -7.5 MB (-0.2%) |
| `/` | 25 ms | 24 ms | -1 ms (-4.0%) |
