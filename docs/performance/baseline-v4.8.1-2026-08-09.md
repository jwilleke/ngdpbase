...
| Version | v4.8.1 |
| Pages on disk | 17912 |
| Resident memory (idle) | 3582.1 MB |
| Memory source | telemetry |
| Heap used | 988.7 MB |
| Heap total | 1871.1 MB |
| Engine init duration (mean from telemetry) | 5447 ms |
...
## Drift vs baseline-v4.8.0-2026-08-08.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3614.5 MB | 3582.1 MB | -32.4 MB (-0.9%) |
| `/` | 27 ms | 26 ms | -1 ms (-3.7%) |
| `/view/Welcome` | 22 ms | 22 ms | +0 ms (+0.0%) |
| `/search?q=test` | 43 ms | 46 ms | +3 ms (+7.0%) |
