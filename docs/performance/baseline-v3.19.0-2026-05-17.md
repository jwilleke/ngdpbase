...
| Version | v3.19.0 |
| Pages on disk | 17525 |
| Resident memory (idle) | 3534.0 MB |
| Memory source | telemetry |
| Heap used | 964.3 MB |
| Heap total | 1677.8 MB |
| Engine init duration (mean from telemetry) | 5392 ms |
...
## Drift vs baseline-v3.18.0-2026-05-17.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3683.6 MB | 3534.0 MB | -149.6 MB (-4.1%) |
| `/` | 151 ms | 32 ms | -119 ms (-78.8%) |
| `/view/Welcome` | 20 ms | 23 ms | +3 ms (+15.0%) |
| `/search?q=test` | 145 ms | 142 ms | -3 ms (-2.1%) |
