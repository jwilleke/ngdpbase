...
| Version | v3.39.2 |
| Pages on disk | 17534 |
| Resident memory (idle) | 1334.7 MB |
| Memory source | telemetry |
| Heap used | 703.9 MB |
| Heap total | 774.2 MB |
| Engine init duration (mean from telemetry) | 4462 ms |
...
## Drift vs baseline-v3.39.1-2026-05-23.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1371.5 MB | 1334.7 MB | -36.8 MB (-2.7%) |
| `/` | 134 ms | 149 ms | +15 ms (+11.2%) |
| `/view/Welcome` | 20 ms | 19 ms | -1 ms (-5.0%) |
| `/search?q=test` | 151 ms | 153 ms | +2 ms (+1.3%) |
