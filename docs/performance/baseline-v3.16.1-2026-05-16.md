...
| Version | v3.16.1 |
| Pages on disk | 17523 |
| Resident memory (idle) | 3603.4 MB |
| Memory source | telemetry |
| Heap used | 1766.3 MB |
| Heap total | 2390.9 MB |
| Engine init duration (mean from telemetry) | 5546 ms |
...
## Drift vs baseline-v3.16.0-2026-05-16.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3533.6 MB | 3603.4 MB | +69.8 MB (+2.0%) |
| `/` | 144 ms | 28 ms | -116 ms (-80.6%) |
| `/view/Welcome` | 20 ms | 22 ms | +2 ms (+10.0%) |
| `/search?q=test` | 133 ms | 22 ms | -111 ms (-83.5%) |
