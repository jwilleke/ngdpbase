...
| Version | v3.70.1 |
| Pages on disk | 17822 |
| Resident memory (idle) | 3526.2 MB |
| Memory source | telemetry |
| Heap used | 947.5 MB |
| Heap total | 2274.5 MB |
| Engine init duration (mean from telemetry) | 4966 ms |
...
## Drift vs baseline-v3.70.0-2026-07-26.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3700.8 MB | 3526.2 MB | -174.6 MB (-4.7%) |
| `/` | 26 ms | 25 ms | -1 ms (-3.8%) |
| `/view/Welcome` | 23 ms | 21 ms | -2 ms (-8.7%) |
| `/search?q=test` | 44 ms | 42 ms | -2 ms (-4.5%) |
