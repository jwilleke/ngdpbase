...
| Version | v3.44.6 |
| Pages on disk | 17539 |
| Resident memory (idle) | 1462.5 MB |
| Memory source | telemetry |
| Heap used | 779.3 MB |
| Heap total | 876.8 MB |
| Engine init duration (mean from telemetry) | 4133 ms |
...
## Drift vs baseline-v3.44.5-2026-05-28.md

⚠️  __Regression candidate(s):__ / (+437.0%, +118ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3286.9 MB | 1462.5 MB | -1824.4 MB (-55.5%) |
| `/` | 27 ms | 145 ms | +118 ms (+437.0%) |
| `/view/Welcome` | 21 ms | 21 ms | +0 ms (+0.0%) |
| `/search?q=test` | 156 ms | 154 ms | -2 ms (-1.3%) |
