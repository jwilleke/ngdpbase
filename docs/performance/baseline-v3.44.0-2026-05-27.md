...
| Version | v3.44.0 |
| Pages on disk | 17539 |
| Resident memory (idle) | 3248.5 MB |
| Memory source | telemetry |
| Heap used | 811.1 MB |
| Heap total | 1688.8 MB |
| Engine init duration (mean from telemetry) | 4601 ms |
...
## Drift vs baseline-v3.43.10-2026-05-27.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3150.5 MB | 3248.5 MB | +98.0 MB (+3.1%) |
| `/` | 146 ms | 25 ms | -121 ms (-82.9%) |
| `/view/Welcome` | 20 ms | 19 ms | -1 ms (-5.0%) |
| `/search?q=test` | 151 ms | 37 ms | -114 ms (-75.5%) |
