...
| Version | v3.23.0 |
| Pages on disk | 17534 |
| Resident memory (idle) | 2106.5 MB |
| Memory source | telemetry |
| Heap used | 879.2 MB |
| Heap total | 1441.7 MB |
| Engine init duration (mean from telemetry) | 5632 ms |
| Link-graph entries | 36356 |
...
## Drift vs baseline-v3.22.0-2026-05-19.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1786.9 MB | 2106.5 MB | +319.6 MB (+17.9%) |
| `/` | 145 ms | 29 ms | -116 ms (-80.0%) |
| `/view/Welcome` | 20 ms | 21 ms | +1 ms (+5.0%) |
| `/search?q=test` | 159 ms | 155 ms | -4 ms (-2.5%) |
