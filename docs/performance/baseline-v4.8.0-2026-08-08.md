...
| Version | v4.8.0 |
| Pages on disk | 17912 |
| Resident memory (idle) | 3614.5 MB |
| Memory source | telemetry |
| Heap used | 945.2 MB |
| Heap total | 1833.8 MB |
| Engine init duration (mean from telemetry) | 5576 ms |
| Link-graph entries | 37116 |
...
## Drift vs baseline-v4.7.0-2026-08-08.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3615.4 MB | 3614.5 MB | -0.9 MB (-0.0%) |
| `/` | 24 ms | 27 ms | +3 ms (+12.5%) |
