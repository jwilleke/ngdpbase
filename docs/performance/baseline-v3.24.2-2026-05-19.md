...
| Version | v3.24.2 |
| Pages on disk | 17527 |
| Resident memory (idle) | 1340.7 MB |
...
## Drift vs baseline-v3.24.1-2026-05-19.md

⚠️  __Regression candidate(s):__ / (+390.0%, +117ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1422.2 MB | 1340.7 MB | -81.5 MB (-5.7%) |
| `/` | 30 ms | 147 ms | +117 ms (+390.0%) |
| `/view/Welcome` | 20 ms | 21 ms | +1 ms (+5.0%) |
| `/search?q=test` | 149 ms | 158 ms | +9 ms (+6.0%) |
