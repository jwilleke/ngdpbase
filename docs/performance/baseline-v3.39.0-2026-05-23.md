...
| Version | v3.39.0 |
| Pages on disk | 17534 |
| Resident memory (idle) | 3080.0 MB |
| Memory source | telemetry |
| Heap used | 799.9 MB |
| Heap total | 1291.9 MB |
| Engine init duration (mean from telemetry) | 4327 ms |
...
## Drift vs baseline-v3.38.1-2026-05-23.md

⚠️  __Regression candidate(s):__ memory (+123.9%)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1375.6 MB | 3080.0 MB | +1704.4 MB (+123.9%) |
| `/` | 144 ms | 23 ms | -121 ms (-84.0%) |
| `/view/Welcome` | 25 ms | 19 ms | -6 ms (-24.0%) |
| `/search?q=test` | 155 ms | 39 ms | -116 ms (-74.8%) |
| `/login` | 24 ms | 19 ms | -5 ms (-20.8%) |
