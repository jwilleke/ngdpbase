...
| Version | v4.12.1 |
| Pages on disk | 18129 |
| Resident memory (idle) | 3600.5 MB |
| Memory source | telemetry |
| Heap used | 1024.1 MB |
| Heap total | 1531.2 MB |
| Engine init duration (mean from telemetry) | 5622 ms |
| Link-graph entries | 37465 |
...
## Drift vs baseline-v4.12.0-2026-08-31.md

⚠️  __Regression candidate(s):__ memory (+92.7%)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1868.9 MB | 3600.5 MB | +1731.6 MB (+92.7%) |
