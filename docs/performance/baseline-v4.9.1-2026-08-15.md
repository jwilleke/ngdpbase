# Performance baseline — v4.9.1

Captured 2026-08-15 on instance `pm2-logrotate` (port 3000).
...
| Version | v4.9.1 |
| Pages on disk | 17950 |
| Resident memory (idle) | 3358.8 MB |
| Memory source | telemetry |
| Heap used | 889.0 MB |
| Heap total | 1256.9 MB |
| Engine init duration (mean from telemetry) | 4945 ms |
| Link-graph entries | 37189 |
...
## Drift vs baseline-v4.9.0-2026-08-15.md

⚠️  __Regression candidate(s):__ memory (+89.7%)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1770.7 MB | 3358.8 MB | +1588.1 MB (+89.7%) |
