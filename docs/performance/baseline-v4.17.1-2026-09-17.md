# Performance baseline — v4.17.1

Captured 2026-09-17 on instance `jimstest` (port 3000).
...
| Version | v4.17.1 |
| Pages on disk | 18235 |
| Resident memory (idle) | 3371.6 MB |
| Memory source | telemetry |
| Heap used | 880.3 MB |
| Heap total | 1447.4 MB |
| Engine init duration (mean from telemetry) | 5219 ms |
...
## Drift vs baseline-v4.17.0-2026-09-17.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3609.0 MB | 3371.6 MB | -237.4 MB (-6.6%) |
| `/` | 28 ms | 29 ms | +1 ms (+3.6%) |
| `/view/Welcome` | 23 ms | 24 ms | +1 ms (+4.3%) |
