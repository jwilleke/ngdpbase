...
| Version | v3.43.6 |
| Pages on disk | 17537 |
| Resident memory (idle) | 3319.4 MB |
| Memory source | telemetry |
| Heap used | 1343.0 MB |
| Heap total | 1982.4 MB |
| Engine init duration (mean from telemetry) | 4388 ms |
...
## Drift vs baseline-v3.43.5-2026-05-26.md

⚠️  __Regression candidate(s):__ /search?q=test (+275.0%, +110ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3261.0 MB | 3319.4 MB | +58.4 MB (+1.8%) |
| `/` | 27 ms | 27 ms | +0 ms (+0.0%) |
| `/view/Welcome` | 20 ms | 26 ms | +6 ms (+30.0%) |
| `/search?q=test` | 40 ms | 150 ms | +110 ms (+275.0%) |
