...
| Version | v4.1.0 |
| Pages on disk | 17822 |
| Resident memory (idle) | 3627.7 MB |
| Memory source | telemetry |
| Heap used | 937.1 MB |
| Heap total | 1827.0 MB |
| Engine init duration (mean from telemetry) | 5221 ms |
...
## Drift vs baseline-v4.0.1-2026-07-27.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3519.0 MB | 3627.7 MB | +108.7 MB (+3.1%) |
