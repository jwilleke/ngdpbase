# Performance baseline — v4.8.9

Captured 2026-08-14 on instance `pm2-logrotate` (port 3000).
...
| Version | v4.8.9 |
| Pages on disk | 17944 |
| Resident memory (idle) | 1919.7 MB |
| Memory source | telemetry |
| Heap used | 906.2 MB |
| Heap total | 1118.9 MB |
| Engine init duration (mean from telemetry) | 5783 ms |
...
## Drift vs baseline-v4.8.8-2026-08-14.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3736.9 MB | 1919.7 MB | -1817.2 MB (-48.6%) |
