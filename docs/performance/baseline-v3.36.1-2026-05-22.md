...
| Version | v3.36.1 |
| Pages on disk | 17534 |
| Resident memory (idle) | 3413.9 MB |
| Memory source | telemetry |
| Heap used | 2122.1 MB |
| Heap total | 2205.8 MB |
| Engine init duration (mean from telemetry) | 4458 ms |
...
## Drift vs baseline-v3.36.0-2026-05-22.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3135.7 MB | 3413.9 MB | +278.2 MB (+8.9%) |
| `/` | 156 ms | 156 ms | +0 ms (+0.0%) |
| `/view/Welcome` | 20 ms | 20 ms | +0 ms (+0.0%) |
| `/search?q=test` | 152 ms | 152 ms | +0 ms (+0.0%) |
