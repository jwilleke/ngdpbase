# Performance baseline — v4.3.0

Captured 2026-08-04 on instance `pm2-logrotate` (port 3000).
...
| Version | v4.3.0 |
| Pages on disk | 17868 |
| Resident memory (idle) | 3615.7 MB |
| Memory source | telemetry |
| Heap used | 939.0 MB |
| Heap total | 1743.8 MB |
| Engine init duration (mean from telemetry) | 5231 ms |
...
## Drift vs baseline-v4.2.0-2026-07-28.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3435.9 MB | 3615.7 MB | +179.8 MB (+5.2%) |
