...
| Version | v4.0.1 |
| Pages on disk | 17822 |
| Resident memory (idle) | 3519.0 MB |
| Memory source | telemetry |
| Heap used | 884.8 MB |
| Heap total | 1781.3 MB |
| Engine init duration (mean from telemetry) | 5155 ms |
...
## Drift vs baseline-v4.0.0-2026-07-27.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3752.4 MB | 3519.0 MB | -233.4 MB (-6.2%) |
| `/` | 24 ms | 26 ms | +2 ms (+8.3%) |
