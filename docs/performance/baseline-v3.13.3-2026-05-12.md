...
| Version | v3.13.3 |
| Pages on disk | 17547 |
| Resident memory (idle) | 3595.4 MB |
| Memory source | telemetry |
| Heap used | 913.7 MB |
| Heap total | 1480.2 MB |
| Engine init duration (mean from telemetry) | 5464 ms |
| Link-graph entries | 36344 |
...
## Drift vs baseline-v3.13.2-2026-05-11.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3302.2 MB | 3595.4 MB | +293.2 MB (+8.9%) |
| `/` | 37 ms | 27 ms | -10 ms (-27.0%) |
| `/view/Welcome` | 20 ms | 22 ms | +2 ms (+10.0%) |
| `/search?q=test` | 131 ms | 133 ms | +2 ms (+1.5%) |
