...
| Version | v4.8.8 |
| Pages on disk | 17944 |
| Resident memory (idle) | 3736.9 MB |
| Memory source | telemetry |
| Heap used | 984.8 MB |
| Heap total | 1215.7 MB |
| Engine init duration (mean from telemetry) | 5162 ms |
...
## Drift vs baseline-v4.8.7-2026-08-11.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3532.2 MB | 3736.9 MB | +204.7 MB (+5.8%) |
| `/` | 22 ms | 25 ms | +3 ms (+13.6%) |
