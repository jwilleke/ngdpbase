...
| Version | v3.70.0 |
| Pages on disk | 17820 |
| Resident memory (idle) | 3700.8 MB |
| Memory source | telemetry |
| Heap used | 1009.0 MB |
| Heap total | 1534.8 MB |
| Engine init duration (mean from telemetry) | 5043 ms |
...
## Drift vs baseline-v3.69.0-2026-07-26.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3444.5 MB | 3700.8 MB | +256.3 MB (+7.4%) |
| `/` | 25 ms | 26 ms | +1 ms (+4.0%) |
| `/view/Welcome` | 21 ms | 23 ms | +2 ms (+9.5%) |
| `/search?q=test` | 42 ms | 44 ms | +2 ms (+4.8%) |
