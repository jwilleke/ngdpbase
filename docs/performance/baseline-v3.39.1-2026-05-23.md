...
| Version | v3.39.1 |
| Pages on disk | 17534 |
| Resident memory (idle) | 1371.5 MB |
| Memory source | telemetry |
| Heap used | 800.5 MB |
| Heap total | 811.3 MB |
| Engine init duration (mean from telemetry) | 4819 ms |
...
## Drift vs baseline-v3.39.0-2026-05-23.md

⚠️  __Regression candidate(s):__ / (+482.6%, +111ms); /search?q=test (+287.2%, +112ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3080.0 MB | 1371.5 MB | -1708.5 MB (-55.5%) |
| `/` | 23 ms | 134 ms | +111 ms (+482.6%) |
| `/view/Welcome` | 19 ms | 20 ms | +1 ms (+5.3%) |
| `/search?q=test` | 39 ms | 151 ms | +112 ms (+287.2%) |
