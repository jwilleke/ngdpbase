...
| Version | v3.31.0 |
| Pages on disk | 17532 |
| Resident memory (idle) | 3222.4 MB |
| Memory source | telemetry |
| Heap used | 804.3 MB |
| Heap total | 1473.2 MB |
| Engine init duration (mean from telemetry) | 4545 ms |
...
## Drift vs baseline-v3.30.0-2026-05-21.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3286.2 MB | 3222.4 MB | -63.8 MB (-1.9%) |
| `/` | 26 ms | 25 ms | -1 ms (-3.8%) |
| `/view/Welcome` | 22 ms | 21 ms | -1 ms (-4.5%) |
| `/search?q=test` | 161 ms | 41 ms | -120 ms (-74.5%) |
