...
| Version | v4.8.6 |
| Pages on disk | 17913 |
| Resident memory (idle) | 3570.2 MB |
| Memory source | telemetry |
| Heap used | 980.4 MB |
| Heap total | 1442.2 MB |
| Engine init duration (mean from telemetry) | 5385 ms |
...
## Drift vs baseline-v4.8.5-2026-08-10.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3520.0 MB | 3570.2 MB | +50.2 MB (+1.4%) |
