...
| Version | v4.6.0 |
| Pages on disk | 17911 |
| Resident memory (idle) | 3604.3 MB |
| Memory source | telemetry |
| Heap used | 990.4 MB |
| Heap total | 2129.4 MB |
| Engine init duration (mean from telemetry) | 5405 ms |
...
## Drift vs baseline-v4.5.2-2026-08-07.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3615.0 MB | 3604.3 MB | -10.7 MB (-0.3%) |
