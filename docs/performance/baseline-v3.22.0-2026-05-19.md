...
| Version | v3.22.0 |
| Pages on disk | 17534 |
| Resident memory (idle) | 1786.9 MB |
| Memory source | telemetry |
| Heap used | 965.3 MB |
| Heap total | 1210.5 MB |
| Engine init duration (mean from telemetry) | 5638 ms |
...
## Drift vs baseline-v3.21.0-2026-05-18.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1688.0 MB | 1786.9 MB | +98.9 MB (+5.9%) |
| `/` | 144 ms | 145 ms | +1 ms (+0.7%) |
| `/view/Welcome` | 21 ms | 20 ms | -1 ms (-4.8%) |
| `/search?q=test` | 155 ms | 159 ms | +4 ms (+2.6%) |
