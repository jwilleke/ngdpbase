# Performance baseline — v4.19.0

Captured 2026-09-20 on instance `jimstest` (port 3000).
...
| Version | v4.19.0 |
| Pages on disk | 18266 |
| Resident memory (idle) | 3248.0 MB |
| Memory source | telemetry |
| Heap used | 882.0 MB |
| Heap total | 1571.7 MB |
| Engine init duration (mean from telemetry) | 5598 ms |
| Link-graph entries | 37688 |
...
## Drift vs baseline-v4.18.0-2026-09-18.md

⚠️  __Regression candidate(s):__ memory (+84.0%)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1764.8 MB | 3248.0 MB | +1483.2 MB (+84.0%) |
| `/` | 27 ms | 25 ms | -2 ms (-7.4%) |
| `/view/Welcome` | 22 ms | 22 ms | +0 ms (+0.0%) |
| `/search?q=test` | 51 ms | 48 ms | -3 ms (-5.9%) |
| `/login` | 23 ms | 21 ms | -2 ms (-8.7%) |
