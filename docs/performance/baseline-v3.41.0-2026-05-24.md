...
| Version | v3.41.0 |
| Pages on disk | 17538 |
| Resident memory (idle) | 2857.8 MB |
| Memory source | telemetry |
| Heap used | 768.1 MB |
| Heap total | 1537.0 MB |
| Engine init duration (mean from telemetry) | 4432 ms |
| Link-graph entries | 36368 |
...
## Drift vs baseline-v3.40.0-2026-05-24.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3263.1 MB | 2857.8 MB | -405.3 MB (-12.4%) |
| `/` | 31 ms | 26 ms | -5 ms (-16.1%) |
| `/view/Welcome` | 21 ms | 19 ms | -2 ms (-9.5%) |
| `/search?q=test` | 40 ms | 38 ms | -2 ms (-5.0%) |
| `/login` | 22 ms | 19 ms | -3 ms (-13.6%) |
