...
| Version | v3.15.1 |
| Pages on disk | 17512 |
| Resident memory (idle) | 3548.7 MB |
| Memory source | telemetry |
| Heap used | 942.1 MB |
| Heap total | 1534.0 MB |
| Engine init duration (mean from telemetry) | 5324 ms |
| Link-graph entries | 36323 |
...
## Drift vs baseline-v3.15.0-2026-05-16.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3567.2 MB | 3548.7 MB | -18.5 MB (-0.5%) |
| `/` | 142 ms | 28 ms | -114 ms (-80.3%) |
| `/view/Welcome` | 22 ms | 21 ms | -1 ms (-4.5%) |
| `/search?q=test` | 137 ms | 143 ms | +6 ms (+4.4%) |
