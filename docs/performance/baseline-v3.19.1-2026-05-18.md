...
| Version | v3.19.1 |
| Pages on disk | 17525 |
| Resident memory (idle) | 3713.1 MB |
| Memory source | telemetry |
| Heap used | 1783.6 MB |
| Heap total | 2216.9 MB |
| Engine init duration (mean from telemetry) | 5384 ms |
...
## Drift vs baseline-v3.19.0-2026-05-17.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3534.0 MB | 3713.1 MB | +179.1 MB (+5.1%) |
| `/` | 32 ms | 30 ms | -2 ms (-6.2%) |
| `/view/Welcome` | 23 ms | 22 ms | -1 ms (-4.3%) |
| `/search?q=test` | 142 ms | 142 ms | +0 ms (+0.0%) |
