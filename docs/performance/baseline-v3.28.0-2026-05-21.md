...
| Version | v3.28.0 |
| Pages on disk | 17532 |
| Resident memory (idle) | 3230.2 MB |
| Memory source | telemetry |
| Heap used | 877.9 MB |
| Heap total | 1374.9 MB |
| Engine init duration (mean from telemetry) | 4140 ms |
...
## Drift vs baseline-v3.27.1-2026-05-21.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3288.8 MB | 3230.2 MB | -58.6 MB (-1.8%) |
| `/` | 24 ms | 24 ms | +0 ms (+0.0%) |
| `/view/Welcome` | 19 ms | 19 ms | +0 ms (+0.0%) |
| `/search?q=test` | 144 ms | 37 ms | -107 ms (-74.3%) |
