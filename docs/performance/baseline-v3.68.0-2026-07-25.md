...
| Version | v3.68.0 |
| Pages on disk | 17823 |
| Resident memory (idle) | 3444.7 MB |
| Memory source | telemetry |
| Heap used | 892.7 MB |
| Heap total | 1507.5 MB |
| Engine init duration (mean from telemetry) | 5360 ms |
...
## Drift vs baseline-v3.67.1-2026-07-25.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3446.2 MB | 3444.7 MB | -1.5 MB (-0.0%) |
| `/` | 27 ms | 28 ms | +1 ms (+3.7%) |
| `/view/Welcome` | 20 ms | 21 ms | +1 ms (+5.0%) |
| `/search?q=test` | 159 ms | 44 ms | -115 ms (-72.3%) |
