# Performance baseline — v3.14.0

Captured 2026-05-12 on instance `jimstest` (port 3000).
...
| Version | v3.14.0 |
| Pages on disk | 17549 |
| Resident memory (idle) | 3325.3 MB |
| Memory source | telemetry |
| Heap used | 914.8 MB |
| Heap total | 1896.2 MB |
| Engine init duration (mean from telemetry) | 5693 ms |
...
## Drift vs baseline-v3.13.3-2026-05-12.md

⚠️  __Regression candidate(s):__ / (+488.9%, +132ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3595.4 MB | 3325.3 MB | -270.1 MB (-7.5%) |
| `/` | 27 ms | 159 ms | +132 ms (+488.9%) |
| `/view/Welcome` | 22 ms | 22 ms | +0 ms (+0.0%) |
| `/search?q=test` | 133 ms | 161 ms | +28 ms (+21.1%) |
