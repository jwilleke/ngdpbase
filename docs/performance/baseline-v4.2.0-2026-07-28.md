# Performance baseline — v4.2.0

Captured 2026-07-28 on instance `pm2-logrotate` (port 3000).
...
| Version | v4.2.0 |
| Pages on disk | 17822 |
| Resident memory (idle) | 3435.9 MB |
| Memory source | telemetry |
| Heap used | 969.6 MB |
| Heap total | 2040.1 MB |
| Engine init duration (mean from telemetry) | 4792 ms |
...
## Drift vs baseline-v4.1.0-2026-07-28.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3627.7 MB | 3435.9 MB | -191.8 MB (-5.3%) |
