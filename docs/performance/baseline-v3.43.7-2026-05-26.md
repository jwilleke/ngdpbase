...
| Version | v3.43.7 |
| Pages on disk | 17537 |
| Resident memory (idle) | 3162.0 MB |
| Memory source | telemetry |
| Heap used | 762.0 MB |
| Heap total | 1393.3 MB |
| Engine init duration (mean from telemetry) | 4111 ms |
...
## Drift vs baseline-v3.43.6-2026-05-26.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3319.4 MB | 3162.0 MB | -157.4 MB (-4.7%) |
| `/` | 27 ms | 31 ms | +4 ms (+14.8%) |
| `/view/Welcome` | 26 ms | 21 ms | -5 ms (-19.2%) |
| `/search?q=test` | 150 ms | 157 ms | +7 ms (+4.7%) |
