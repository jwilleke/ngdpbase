...
| Version | v3.33.0 |
| Pages on disk | 17534 |
| Resident memory (idle) | 3035.8 MB |
| Memory source | telemetry |
| Heap used | 708.5 MB |
| Heap total | 1407.2 MB |
| Engine init duration (mean from telemetry) | 4212 ms |
...
## Drift vs baseline-v3.32.0-2026-05-21.md

⚠️  __Regression candidate(s):__ / (+440.0%, +110ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3134.9 MB | 3035.8 MB | -99.1 MB (-3.2%) |
| `/` | 25 ms | 135 ms | +110 ms (+440.0%) |
| `/view/Welcome` | 20 ms | 20 ms | +0 ms (+0.0%) |
| `/search?q=test` | 152 ms | 148 ms | -4 ms (-2.6%) |
