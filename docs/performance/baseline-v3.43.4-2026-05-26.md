...
| Version | v3.43.4 |
| Pages on disk | 17537 |
| Resident memory (idle) | 3233.0 MB |
| Memory source | telemetry |
| Heap used | 813.6 MB |
| Heap total | 1215.9 MB |
| Engine init duration (mean from telemetry) | 4539 ms |
...
## Drift vs baseline-v3.43.3-2026-05-26.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3223.0 MB | 3233.0 MB | +10.0 MB (+0.3%) |
| `/` | 149 ms | 26 ms | -123 ms (-82.6%) |
