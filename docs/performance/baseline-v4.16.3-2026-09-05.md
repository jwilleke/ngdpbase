...
| Version | v4.16.3 |
| Pages on disk | 18153 |
| Resident memory (idle) | 3513.8 MB |
| Memory source | telemetry |
| Heap used | 1077.7 MB |
| Heap total | 1477.5 MB |
| Engine init duration (mean from telemetry) | 5353 ms |
...
## Drift vs baseline-v4.16.2-2026-09-05.md

⚠️  __Regression candidate(s):__ memory (+76.8%)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1986.9 MB | 3513.8 MB | +1526.9 MB (+76.8%) |
| `/` | 38 ms | 28 ms | -10 ms (-26.3%) |
| `/view/Welcome` | 34 ms | 23 ms | -11 ms (-32.4%) |
| `/search?q=test` | 58 ms | 48 ms | -10 ms (-17.2%) |
| `/login` | 33 ms | 23 ms | -10 ms (-30.3%) |
