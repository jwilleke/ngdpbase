# Performance baseline — v4.16.6

Captured 2026-09-16 on instance `jimstest` (port 3000).
...
| Version | v4.16.6 |
| Pages on disk | 18232 |
| Resident memory (idle) | 3405.3 MB |
| Memory source | telemetry |
| Heap used | 916.3 MB |
| Heap total | 1568.6 MB |
| Engine init duration (mean from telemetry) | 5380 ms |
...
## Drift vs baseline-v4.16.5-2026-09-06.md

⚠️  __Regression candidate(s):__ memory (+68.2%)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 2025.0 MB | 3405.3 MB | +1380.3 MB (+68.2%) |
| `/` | 37 ms | 26 ms | -11 ms (-29.7%) |
| `/view/Welcome` | 33 ms | 23 ms | -10 ms (-30.3%) |
| `/search?q=test` | 59 ms | 47 ms | -12 ms (-20.3%) |
| `/login` | 32 ms | 22 ms | -10 ms (-31.2%) |
