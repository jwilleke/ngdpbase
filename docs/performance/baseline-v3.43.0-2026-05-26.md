...
| Version | v3.43.0 |
| Pages on disk | 17537 |
| Resident memory (idle) | 3333.8 MB |
| Memory source | telemetry |
| Heap used | 1338.7 MB |
| Heap total | 2117.4 MB |
| Engine init duration (mean from telemetry) | 4372 ms |
...
## Drift vs baseline-v3.42.0-2026-05-25.md

⚠️  __Regression candidate(s):__ memory (+129.4%)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1453.4 MB | 3333.8 MB | +1880.4 MB (+129.4%) |
| `/` | 140 ms | 29 ms | -111 ms (-79.3%) |
| `/view/Welcome` | 20 ms | 21 ms | +1 ms (+5.0%) |
| `/search?q=test` | 155 ms | 145 ms | -10 ms (-6.5%) |
