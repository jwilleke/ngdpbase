...
| Version | v3.61.0 |
| Pages on disk | 17821 |
| Resident memory (idle) | 3392.3 MB |
| Memory source | telemetry |
| Heap used | 920.5 MB |
| Heap total | 1643.2 MB |
| Engine init duration (mean from telemetry) | 4637 ms |
...
## Drift vs baseline-v3.60.0-2026-07-22.md

⚠️  __Regression candidate(s):__ /search?q=test (+293.0%, +126ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3508.5 MB | 3392.3 MB | -116.2 MB (-3.3%) |
| `/` | 26 ms | 27 ms | +1 ms (+3.8%) |
| `/view/Welcome` | 22 ms | 22 ms | +0 ms (+0.0%) |
| `/search?q=test` | 43 ms | 169 ms | +126 ms (+293.0%) |
