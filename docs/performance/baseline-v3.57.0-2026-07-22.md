...
| Version | v3.57.0 |
| Pages on disk | 17821 |
| Resident memory (idle) | 3519.8 MB |
| Memory source | telemetry |
| Heap used | 997.7 MB |
| Heap total | 1744.3 MB |
...
## Drift vs baseline-v3.56.0-2026-07-21.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3175.6 MB | 3519.8 MB | +344.2 MB (+10.8%) |
| `/` | 26 ms | 26 ms | +0 ms (+0.0%) |
| `/view/Welcome` | 21 ms | 22 ms | +1 ms (+4.8%) |
| `/search?q=test` | 45 ms | 44 ms | -1 ms (-2.2%) |
