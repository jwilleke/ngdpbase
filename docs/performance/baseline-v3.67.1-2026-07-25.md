# Performance baseline — v3.67.1

Captured 2026-07-25 on instance `pm2-logrotate` (port 3000).
...
| Version | v3.67.1 |
| Pages on disk | 17822 |
| Resident memory (idle) | 3446.2 MB |
| Memory source | telemetry |
| Heap used | 939.5 MB |
| Heap total | 1822.8 MB |
| Engine init duration (mean from telemetry) | 5036 ms |
...
## Drift vs baseline-v3.66.0-2026-07-24.md

⚠️  __Regression candidate(s):__ /search?q=test (+261.4%, +115ms)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3551.0 MB | 3446.2 MB | -104.8 MB (-3.0%) |
| `/` | 29 ms | 27 ms | -2 ms (-6.9%) |
| `/view/Welcome` | 21 ms | 20 ms | -1 ms (-4.8%) |
| `/search?q=test` | 44 ms | 159 ms | +115 ms (+261.4%) |
