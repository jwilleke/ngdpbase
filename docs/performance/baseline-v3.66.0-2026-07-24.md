...
| Version | v3.66.0 |
| Pages on disk | 17822 |
| Resident memory (idle) | 3551.0 MB |
| Memory source | telemetry |
| Heap used | 900.2 MB |
| Heap total | 1848.9 MB |
...
## Drift vs baseline-v3.65.0-2026-07-24.md

⚠️  __Regression candidate(s):__ memory (+58.1%)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 2245.9 MB | 3551.0 MB | +1305.1 MB (+58.1%) |
| `/` | 145 ms | 29 ms | -116 ms (-80.0%) |
| `/view/Welcome` | 20 ms | 21 ms | +1 ms (+5.0%) |
| `/search?q=test` | 154 ms | 44 ms | -110 ms (-71.4%) |
