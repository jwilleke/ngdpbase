...
| Version | v4.16.4 |
| Pages on disk | 18156 |
| Resident memory (idle) | 3530.7 MB |
| Memory source | telemetry |
| Heap used | 998.1 MB |
| Heap total | 1760.1 MB |
| Engine init duration (mean from telemetry) | 5404 ms |
...
## Drift vs baseline-v4.16.3-2026-09-05.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3513.8 MB | 3530.7 MB | +16.9 MB (+0.5%) |
| `/` | 28 ms | 37 ms | +9 ms (+32.1%) |
| `/view/Welcome` | 23 ms | 32 ms | +9 ms (+39.1%) |
| `/search?q=test` | 48 ms | 62 ms | +14 ms (+29.2%) |
| `/login` | 23 ms | 32 ms | +9 ms (+39.1%) |
