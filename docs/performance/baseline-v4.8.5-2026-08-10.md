...
| Version | v4.8.5 |
| Pages on disk | 17913 |
| Resident memory (idle) | 3520.0 MB |
| Memory source | telemetry |
| Heap used | 980.7 MB |
| Heap total | 1497.9 MB |
| Engine init duration (mean from telemetry) | 5059 ms |
...
## Drift vs baseline-v4.8.4-2026-08-10.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3735.5 MB | 3520.0 MB | -215.5 MB (-5.8%) |
| `/` | 25 ms | 26 ms | +1 ms (+4.0%) |
| `/view/Welcome` | 22 ms | 22 ms | +0 ms (+0.0%) |
| `/search?q=test` | 46 ms | 43 ms | -3 ms (-6.5%) |
