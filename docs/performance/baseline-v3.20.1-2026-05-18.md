...
| Version | v3.20.1 |
| Pages on disk | 17531 |
| Resident memory (idle) | 3657.7 MB |
| Memory source | telemetry |
| Heap used | 1757.2 MB |
| Heap total | 2561.9 MB |
| Engine init duration (mean from telemetry) | 5855 ms |
...
## Drift vs baseline-v3.20.0-2026-05-18.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3527.8 MB | 3657.7 MB | +129.9 MB (+3.7%) |
| `/` | 27 ms | 33 ms | +6 ms (+22.2%) |
| `/view/Welcome` | 21 ms | 21 ms | +0 ms (+0.0%) |
| `/search?q=test` | 26 ms | 26 ms | +0 ms (+0.0%) |
