...
| Version | v4.7.0 |
| Pages on disk | 17912 |
| Resident memory (idle) | 3615.4 MB |
| Memory source | telemetry |
| Heap used | 996.9 MB |
| Heap total | 1824.8 MB |
| Engine init duration (mean from telemetry) | 5323 ms |
...
## Drift vs baseline-v4.6.2-2026-08-08.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3551.8 MB | 3615.4 MB | +63.6 MB (+1.8%) |
| `/` | 28 ms | 24 ms | -4 ms (-14.3%) |
| `/view/Welcome` | 23 ms | 21 ms | -2 ms (-8.7%) |
| `/search?q=test` | 46 ms | 45 ms | -1 ms (-2.2%) |
