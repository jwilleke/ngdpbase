...
| Version | v3.43.3 |
| Pages on disk | 17537 |
| Resident memory (idle) | 3223.0 MB |
| Memory source | telemetry |
| Heap used | 1508.8 MB |
| Heap total | 1621.1 MB |
| Engine init duration (mean from telemetry) | 4211 ms |
...
## Drift vs baseline-v3.43.2-2026-05-26.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3222.0 MB | 3223.0 MB | +1.0 MB (+0.0%) |
| `/` | 145 ms | 149 ms | +4 ms (+2.8%) |
| `/view/Welcome` | 20 ms | 20 ms | +0 ms (+0.0%) |
| `/search?q=test` | 149 ms | 157 ms | +8 ms (+5.4%) |
