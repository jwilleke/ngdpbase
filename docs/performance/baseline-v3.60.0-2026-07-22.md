...
| Version | v3.60.0 |
| Pages on disk | 17821 |
| Resident memory (idle) | 3508.5 MB |
| Memory source | telemetry |
| Heap used | 940.7 MB |
| Heap total | 1574.1 MB |
| Engine init duration (mean from telemetry) | 5071 ms |
...
## Drift vs baseline-v3.59.0-2026-07-22.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3429.1 MB | 3508.5 MB | +79.4 MB (+2.3%) |
| `/` | 25 ms | 26 ms | +1 ms (+4.0%) |
| `/view/Welcome` | 22 ms | 22 ms | +0 ms (+0.0%) |
| `/search?q=test` | 166 ms | 43 ms | -123 ms (-74.1%) |
