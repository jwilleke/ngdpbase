# Performance baseline — v3.46.0

Captured 2026-05-30 on instance `jimstest` (port 3000).
...
| Version | v3.46.0 |
| Pages on disk | 17541 |
| Resident memory (idle) | 1522.9 MB |
| Memory source | telemetry |
| Heap used | 744.6 MB |
| Heap total | 853.5 MB |
| Engine init duration (mean from telemetry) | 4553 ms |
...
## Drift vs baseline-v3.45.0-2026-05-28.md

⚠️  __Regression candidate(s):__ memory (+29.8%)

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 1173.6 MB | 1522.9 MB | +349.3 MB (+29.8%) |
| `/` | 145 ms | 133 ms | -12 ms (-8.3%) |
| `/view/Welcome` | 27 ms | 20 ms | -7 ms (-25.9%) |
| `/search?q=test` | 153 ms | 148 ms | -5 ms (-3.3%) |
| `/login` | 22 ms | 20 ms | -2 ms (-9.1%) |
