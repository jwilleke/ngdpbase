...
| Version | v3.62.1 |
| Pages on disk | 17821 |
| Resident memory (idle) | 3457.0 MB |
| Memory source | telemetry |
| Heap used | 933.8 MB |
| Heap total | 1860.9 MB |
| Engine init duration (mean from telemetry) | 5111 ms |
...
## Drift vs baseline-v3.62.0-2026-07-23.md

| Metric | Previous | New | Δ |
| --- | --- | --- | --- |
| Memory (idle) | 3438.9 MB | 3457.0 MB | +18.1 MB (+0.5%) |
