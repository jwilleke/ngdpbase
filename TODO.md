...
Generated priority mirror of open GitHub issues and pull requests — the `P0` / `P1` / `P2` / `in-review` / `deferred` labels are the source of truth. Regenerated by `/pstatus` (2026-07-27, at v3.70.2). For live state run `/pstatus`. Prior hand-curated narrative is in this file's git history.
...
- [#971](https://github.com/jwilleke/ngdpbase/issues/971) — [FEATURE] Seeder never stamps access: { edit: ['admin'] } — addons.md §3 admin-only editing is settled but unimplemented
- [#970](https://github.com/jwilleke/ngdpbase/issues/970) — [BUG] E2E runs that crash before cleanup leave live NGDPBASE-test-* pages in the index forever
