...
Generated priority mirror of open GitHub issues and pull requests — the `P0` / `P1` / `P2` / `in-review` / `deferred` labels are the source of truth. Regenerated by `/pstatus` (2026-07-27, at v3.70.2 +3). For live state run `/pstatus`. Prior hand-curated narrative is in this file's git history.
...
- [#991](https://github.com/jwilleke/ngdpbase/pull/991) — feat(addons): backfill access onto pages seeded before stamping existed (#971) *(ready)*
