...
- [#1119](https://github.com/jwilleke/ngdpbase/issues/1119) — [FEATURE] Audit integrity in the provider contract — sequence numbers and a hash chain, stamped by BaseAuditProvider
- [#1118](https://github.com/jwilleke/ngdpbase/issues/1118) — [BUG] A failed audit provider silently falls back to NullAuditProvider — the instance discards every event and reports healthy
