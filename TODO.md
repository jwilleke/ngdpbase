...
- [#1127](https://github.com/jwilleke/ngdpbase/issues/1127) — [FEATURE] [FEATURE] ngdp Compatible Markdown - As dropdown /edit/ "More.."
- [#1126](https://github.com/jwilleke/ngdpbase/issues/1126) — [FEATURE] ngdp Compatible Markdown - Path for import an ingesting
- [#1123](https://github.com/jwilleke/ngdpbase/issues/1123) — [BUG] comments do not support NCM

## 🟡 P2

- [#1125](https://github.com/jwilleke/ngdpbase/issues/1125) — [FEATURE]  ngdp Compatible Markdown (NCM) Capture Footnotes Properly
