...
Generated priority mirror of open GitHub issues — the `P0` / `P1` / `P2` / `in-review` / `deferred` labels are the source of truth. Regenerated by `/pstatus` (2026-07-26, at v3.69.0). For live state run `/pstatus`. Prior hand-curated narrative is in this file's git history.
...
- [#956](https://github.com/jwilleke/ngdpbase/issues/956) — [security] Base-image bundled npm — node-tar stack-overflow DoS + brace-expansion OOM (GHSA-r292-9mhp-454m, CVE-2026-14257) *(security)*
- [#946](https://github.com/jwilleke/ngdpbase/issues/946) — [FEATURE] User-delegated agent API tokens — mint/revoke your own scoped, short-lived bearer credentials *(security)*
...
- [#964](https://github.com/jwilleke/ngdpbase/issues/964) — [bug] Admin Required Pages Sync treats addon page source filename as UUID
