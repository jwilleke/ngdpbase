...
- [#1004](https://github.com/jwilleke/ngdpbase/issues/1004) — [BUG] How can a user see all of his captures? — *`/my/captures` shipped in `41c5717c`, released in v4.2.0; the populated list is still unverified — jimstest has zero capture pages*
