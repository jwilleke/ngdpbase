...
- Blockers / significant notes:
  ...
  - __No kill-mid-write e2e__ exists for either. Deliberate — #1061's e2e hit repeated harness flakiness and I removed it rather than ship a flaky guard. Worth its own piece of work.
  - __fsync is OFF by default__ in `writeFileAtomic`. Measured 8.62 ms/write on vs 0.27 ms off (~+150 s on an 18k-page rebuild). Covers power loss only; process kills are already safe. One word flips it if you want the stronger guarantee.
