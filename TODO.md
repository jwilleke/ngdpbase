...
- [#1076](https://github.com/jwilleke/ngdpbase/issues/1076) — [BUG] We should support heic images format
...
- [#1074](https://github.com/jwilleke/ngdpbase/issues/1074) — [kit] Kit Sync cannot open its pull request
- [#1068](https://github.com/jwilleke/ngdpbase/issues/1068) — [kit] .claude/commands/semver.md already exists here — kit copy installed as .claude/commands/semver-kit.md
...
- [#1075](https://github.com/jwilleke/ngdpbase/pull/1075) — chore(kit): sync to v1.11.4-5-g17d7aa6 *(PR · ready)* — no linked issue
