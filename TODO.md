...
lastModified: '2026-07-27T14:30:00.000Z'
slug: ngdpbase-todo
---

# Project Development TODO

Generated priority mirror of open GitHub issues and pull requests — the `P0` / `P1` / `P2` / `in-review` / `deferred` labels are the source of truth. Regenerated by `/pstatus` (2026-07-27, at v3.71.0). For live state run `/pstatus`. Prior hand-curated narrative is in this file's git history.
...
- [#1000](https://github.com/jwilleke/ngdpbase/issues/1000) — [SECURITY] showdown CVE-2024-1899 — 3 alerts unfixable upstream, mitigated in-app — *decision issue: dismiss-as-mitigated vs migrate to `marked`*
