...
lastModified: '2026-07-27T21:00:00.000Z'
slug: ngdpbase-todo
---

# Project Development TODO

Generated priority mirror of open GitHub issues and pull requests — the `P0` / `P1` / `P2` / `in-review` / `deferred` labels are the source of truth. Regenerated by `/pstatus` (2026-07-27, at v4.0.0 +1). For live state run `/pstatus`. Prior hand-curated narrative is in this file's git history.
...
- [#1003](https://github.com/jwilleke/ngdpbase/issues/1003) — [BUG] system-category never backfills on already-seeded pages; access-backfill also picks the stale category
