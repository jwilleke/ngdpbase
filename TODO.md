...
lastModified: '2026-07-27T19:45:00.000Z'
slug: ngdpbase-todo
---

# Project Development TODO

Generated priority mirror of open GitHub issues and pull requests — the `P0` / `P1` / `P2` / `in-review` / `deferred` labels are the source of truth. Regenerated by `/session-commit` (2026-07-27, at v3.71.0 +3). For live state run `/pstatus`. Prior hand-curated narrative is in this file's git history.
