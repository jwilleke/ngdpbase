...
lastModified: '2026-05-23T16:45:00.000Z'
slug: ngdpbase-todo
---
...
| #684 | Route-test infra hardening | Low — `buildTestApp` helper + 3 reference migrations landed (`2e2d6396` coverage9+contact, `02330ca2` imageUpload covers multipart/header-only); remaining ~30 tests migrate opportunistically when touched |
