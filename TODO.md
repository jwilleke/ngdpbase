...
| #684 | Route-test infra hardening | Low — `buildTestApp` helper + 2 reference migrations landed `2e2d6396`; remaining ~30 tests migrate opportunistically when touched |
