...
Generated priority mirror of open GitHub issues — the `P0` / `P1` / `P2` / `deferred` labels are the source of truth. Regenerated by `/session-commit` (2026-07-22). For live state run `/pstatus`. Prior hand-curated narrative is in this file's git history.
