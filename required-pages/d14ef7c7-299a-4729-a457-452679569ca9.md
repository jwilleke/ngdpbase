...
Media items linked to a [Private Pages] page are visible only to that page's owner — administrators included in the refusal. Items with no page association are visible to all users.
