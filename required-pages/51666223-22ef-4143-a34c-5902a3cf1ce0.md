...
- **Upload** — click the **Upload** button in the Attachments section to upload a new file directly to the page
- **Browse Assets** — click **Browse Assets** to open the asset picker and insert files from the shared media library or existing page attachments
