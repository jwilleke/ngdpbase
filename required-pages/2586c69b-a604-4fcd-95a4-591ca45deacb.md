...
Note: attachments uploaded while the page was private are **not** automatically moved. See [Private Attachments|#private-attachments] above.
...
When a user who is not the creator or an admin tries to reach a private page, [{$applicationname}] returns **HTTP 403 Access Denied**. This applies to:
