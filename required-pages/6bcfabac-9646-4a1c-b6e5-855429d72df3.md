...
| `ngdpbase.audit.read-events` | `false` | `false` | `true` |
...
`read-events` records who looked at what, not only who changed what. That is noise on a general-purpose instance and the entire point on one holding records about people.
