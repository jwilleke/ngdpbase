...
[{ConfigAccessor key='ngdpbase.approver.*'}]
...
[{ConfigAccessor key='ngdpbase.login-module.*'}]

### `ngdpbase.lucene-search-provider.*`

[{ConfigAccessor key='ngdpbase.lucene-search-provider.*'}]
...
[{ConfigAccessor key='ngdpbase.plugins.*'}]
...
[{ConfigAccessor key='ngdpbase.specialpage.*'}]
...
[{ConfigAccessor key='ngdpbase.workflow.*'}]

### `ngdpbase.xmlGroupDatabase.*`

[{ConfigAccessor key='ngdpbase.xmlGroupDatabase.*'}]

### `ngdpbase.xmlUserDatabase.*`

[{ConfigAccessor key='ngdpbase.xmlUserDatabase.*'}]
...
- `ngdpbase.groupdatabase`: [{ConfigAccessor key='ngdpbase.groupdatabase' valueonly='true'}]
...
- `ngdpbase.jsonuserdatabase`: [{ConfigAccessor key='ngdpbase.jsonuserdatabase' valueonly='true'}]
- `ngdpbase.pageFilters`: [{ConfigAccessor key='ngdpbase.pageFilters' valueonly='true'}]
- `ngdpbase.referenceStyle`: [{ConfigAccessor key='ngdpbase.referenceStyle' valueonly='true'}]
...
- `ngdpbase.templateDir`: [{ConfigAccessor key='ngdpbase.templateDir' valueonly='true'}]
...
- `ngdpbase.userdatabase`: [{ConfigAccessor key='ngdpbase.userdatabase' valueonly='true'}]
- `ngdpbase.version`: [{ConfigAccessor key='ngdpbase.version' valueonly='true'}]
- `ngdpbase.workDir`: [{ConfigAccessor key='ngdpbase.workDir' valueonly='true'}]
