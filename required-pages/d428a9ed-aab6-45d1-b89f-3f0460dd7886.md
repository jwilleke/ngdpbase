...
Only users with the __admin__ or __editor__ role can create shares.
...
On `/shares`, press __Revoke__ next to any active or expired share. Revocation is immediate — the link stops working on the next request. Editors can revoke their own shares; admins can revoke anyone's. Revoked shares stay in the list for the audit trail.
