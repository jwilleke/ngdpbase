...
[{$applicationname}] displays a left-side navigation menu on every page. By default it shows the built-in [LeftMenu] page. You can replace it with your own content by creating — or editing — a page named __left-menu-content__.
