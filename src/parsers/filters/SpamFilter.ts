  ...
  loadModularSpamConfiguration(context: InitContext): void {
    ...
    if (configManager) {
      try {
        ...
        this.spamConfig.maxLinks = configManager.getProperty('ngdpbase.filters.spam.max-links', this.spamConfig.maxLinks) as number;
        this.spamConfig.maxImages = configManager.getProperty('ngdpbase.filters.spam.max-images', this.spamConfig.maxImages) as number;
        this.spamConfig.cacheBlacklist = configManager.getProperty('ngdpbase.filters.spam.cache-blacklist', this.spamConfig.cacheBlacklist) as boolean;

        // Load blacklisted words (modular blacklist)
        const blacklistWords = configManager.getProperty('ngdpbase.filters.spam.blacklist-words', '') as string;
        if (blacklistWords) {
        ...
        const whitelistDomains = configManager.getProperty('ngdpbase.filters.spam.whitelist-domains', '') as string;
        if (whitelistDomains) {
        ...
        this.spamConfig.minContentLength = configManager.getProperty('ngdpbase.filters.spam.min-content-length', this.spamConfig.minContentLength) as number;
        this.spamConfig.autoBlock = configManager.getProperty('ngdpbase.filters.spam.auto-block', this.spamConfig.autoBlock) as boolean;
        this.spamConfig.logSpamAttempts = configManager.getProperty('ngdpbase.filters.spam.log-spam-attempts', this.spamConfig.logSpamAttempts) as boolean;
