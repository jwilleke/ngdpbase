...
${panes}
  ...
  // #1216 (operator 2026-09-21): the dedicated policy editor that sat here —
  // adminPolicies, adminCreatePolicy, adminGetPolicy, adminUpdatePolicy,
  // adminDeletePolicy — is gone. None was routed (/admin/policies was a 404),
  // nothing linked to it, and its save path called PolicyManager methods that
  // do not exist. Policies are edited in /admin/configuration, which writes
  // through ConfigurationManager.setProperty with the actor and records the
  // change in the audit log (#1150). /admin/roles shows the read-only role x
  // permission summary derived from them.
