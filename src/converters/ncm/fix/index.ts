 ...
 * lists.
 */
export const FIX_STEPS: readonly FixStep[] = [jspwikiCodeMarkers, jspwikiHeadings, jspwikiItalic, styleClosers, moreInformationFooter, jspwikiBullets, bulletMarkers, tightenLists];
